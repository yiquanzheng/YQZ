...
#ifndef TopicTypesPlugin_115571206_h
#define TopicTypesPlugin_115571206_h
...
extern "C" {
    ...
    #define SoftwareStatePlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
    #define SoftwareStatePlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
    #define SoftwareStatePlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

    #define SoftwareStatePlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
    #define SoftwareStatePlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

    /* --------------------------------------------------------------------------------------
    Support functions:
    * -------------------------------------------------------------------------------------- */

    NDDSUSERDllExport extern SoftwareState*
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    SoftwareStatePlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        SoftwareState * sample,
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
    ...
    NDDSUSERDllExport extern RTIBool 
    SoftwareStatePlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        SoftwareState ** sample,
        RTIBool * drop_sample,
        struct RTICdrStream *stream,
    ...
    SoftwareStatePlugin_new(void);

    NDDSUSERDllExport extern void
    SoftwareStatePlugin_delete(struct PRESTypePlugin *);
...
#endif /* TopicTypesPlugin_115571206_h */
